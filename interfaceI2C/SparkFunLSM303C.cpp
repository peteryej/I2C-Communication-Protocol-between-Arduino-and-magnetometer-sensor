...
//commented out all SPI related lines due to bitSet conflict, line 653, 675, 697, 723
...
uint8_t LSM303C::MAG_WhoAMI_Read(void)
{
  uint8_t data = 0;
  if (MAG_ReadReg(MAG_WHO_AM_I, data) ){
    debug_printlns("Failed Read from MAG_WHO_AM_I REG");
  }
  return data;
}
